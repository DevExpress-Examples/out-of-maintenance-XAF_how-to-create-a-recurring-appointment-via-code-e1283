    ...
    Friend Class Program
        ...
        Private Shared Sub CreateRecurringAppointment()
            Using session As New Session(XpoDefault.DataLayer)
                Dim ri As New RecurrenceInfo(Date.Now, TimeSpan.FromMinutes(30))
                ...
                appointment.StartOn = Date.Now
                appointment.Type = CInt((AppointmentType.Pattern))
                Dim helper As New RecurrenceInfoXmlPersistenceHelper(ri)
